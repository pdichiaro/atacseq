...
workflow ATACSEQ {
    ...
    // Differently from standard nf-core atacseq we can evaluate the possibility to run the ATAC-seq w/o inputs
    ...
    ch_macs2_branched
        ...
        .subscribe { meta, peaks ->
            ...
            1. Poor ATAC-seq enrichment
               → Check ATAC-seq quality metrics (FRiP, NSC, RSC scores)
               → Verify Tn5 tagmentation and ATAC-seq protocol
        ...
        .subscribe { count ->
            if (count == 0) {
                ...
                4. Review experimental design:
                   → Verify Tn5 tagmentation efficiency
                   → Check ATAC-seq protocol efficiency
